...
class LibraryTransactionController extends ControllerBase {
   ...
   */
  public function __construct(EntityTypeManagerInterface $entity_type_manager, EntityFormBuilderInterface $entity_form_builder, AccountProxyInterface $current_user, LendingLibraryManagerInterface $lending_library_manager) {
